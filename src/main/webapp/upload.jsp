...
<title>Upload a .zip package</title>
</head>
<body>
...
<input type="submit" value="Home"/>
	...
	<h3>Project: <% out.print(servername); %></h3>
...
<p>
<field><input type="text" name="filename" size="20"/><span> Folder name (No spaces, no special characters)</span></field>
</p>
<p>
